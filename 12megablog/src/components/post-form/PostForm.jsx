...
function PostForm({ post }) {
	// "watch" is used to moniitor changes in the form
	// "setValue" will be used to setting the changes inside the form
	// "control" will give the control of the RTE to this form
	// "getValue" to get the values from the form
	...
	useEffect(() => {
		...
		// this is used for optimised writing of code
		return () => {
